...
<div id="intro" class="section scrollspy">
    <div class="container">
        <div class="row">
            <div  class="col s12">
                <h2 class="center header text_h2"> Uma plataforma que preza a usabilidade e otimiza o processo de <span class="deep-orange-text span_h2"> criação, tradução e gerenciamento  </span>de provas para alunos <span class="deep-orange-text span_h2">deficientes auditivos.</span> </h2>
            </div>

            <div  class="col s12 m4 l4">
                <div class="center promo promo-example">
                    <i class="mdi-image-flash-on deep-orange-text"></i>
                    <h5 class="promo-caption">Otimização</h5>
                    <p class="light center">Sua interface intuitiva e amigável permite que você navegue facilmente pelas funcionalidades e gerencie suas provas de maneira prática e rápida.</p>
                </div>
            </div>
            <div class="col s12 m4 l4">
                <div class="center promo promo-example">
                    <i class="mdi-social-group deep-orange-text"></i>
                    <h5 class="promo-caption">Colaboração</h5>
                    <p class="light center">Sua usabilidade permite que professores e intérpretes colaborem simultaneamente com o processo de elaboração da avaliação de maneira limpa e organizada.</p>
                </div>
            </div>
            <div class="col s12 m4 l4">
                <div class="center promo promo-example">
                    <i class="mdi-hardware-desktop-windows deep-orange-text"></i>
                    <h5 class="promo-caption">Inclusão</h5>
                    <p class="light center">A aplicação de prova permite que alunos ouvintes e deficientes auditivos realizem as avaliações em sua língua materna, utilizando como recurso a língua portuguesa e Libras.</p>
                </div>
            </div>
        </div>
    </div>
